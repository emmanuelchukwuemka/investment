...
<div class="zei-page-hero">
    <img src="{{ asset('lassets/images/banner/contact.png') }}" alt="Cfds" class="zei-page-hero-bg">
    <div class="zei-page-hero-overlay"></div>
    <div class="container">
        <div class="zei-page-hero-content">
            <div class="zei-breadcrumb"><a href="{{ route('home') }}">Home</a><span class="sep">&#8250;</span><span class="cur">Cfds</span></div>
            <h1 class="zei-page-title">Cfds</h1>
            <p class="zei-page-sub">Expert Cfds investment services managed by our professional trading team.</p>
        </div>
    </div>
</div>
<div class="zei-section">
    <div class="container">
        <div class="row align-items-center g-5">
            <div class="col-lg-6">
                <img src="{{ asset('img/people.jpg') }}" alt="Cfds" style="width:100%;height:400px;object-fit:cover;border-radius:16px">
            </div>
            <div class="col-lg-6">
                <span class="zei-label">Market Expertise</span>
                <h2 class="zei-title">Professional Cfds<br>Trading Services</h2>
                <p style="font-size:15px;color:var(--muted);line-height:1.8;margin-bottom:24px">Our expert team provides professional Cfds trading services with deep market analysis, risk management, and consistent returns for our investors.</p>
